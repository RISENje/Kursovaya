...
// Kursovaya.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKursovayaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKursovayaApp

CKursovayaApp::CKursovayaApp()
{
...
// Единственный объект CKursovayaApp

CKursovayaApp theApp;


// Инициализация CKursovayaApp

BOOL CKursovayaApp::InitInstance()
{
